...
public class LoginJDialog extends javax.swing.JFrame {
    ...
    NhanVienRepository ServiceNhanVien = new NhanVienRepository();
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        NhanVien nv = ServiceNhanVien.selectAccout(txtEmail.getText(), txtMatKhau.getText());
        switch (nv.getChucVu()) {
            case -2 -> {
            ...
            case 1 -> {
                new Main(true, nv).setVisible(true);
                this.dispose();
            }
            default -> {
                new Main(false, nv).setVisible(true);
                this.dispose();
            }
        }
